    ...
    <div class="news3list">
      <el-card class="box-card" shadow="hover">
        <div slot="header" class="clearfix">
          <span style="color: #ad2a2a">轻大快讯</span>
          <a
            href="https://www.zzuli.edu.cn/303/list.htm"
      ...
      <el-card class="box-card" shadow="hover">
        <div slot="header" class="clearfix">
          <span style="color: #ad2a2a">轻大故事</span>
          <a
            href="https://www.zzuli.edu.cn/qgdgs/list.htm"
            style="float: right; padding: 3px 0"
            >更 多>></a
          >
        </div>
      ...
      <el-card class="box-card" shadow="hover">
        <div slot="header" class="clearfix">
          <span style="color: #ad2a2a">轻大媒体</span>
          <a
            href="https://www.zzuli.edu.cn/225/list.htm"
            style="float: right; padding: 3px 0"
            >更 多>></a
          >
        </div>
